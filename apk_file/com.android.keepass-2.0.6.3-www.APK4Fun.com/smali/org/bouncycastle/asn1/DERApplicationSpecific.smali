...
.method public constructor <init>(ILorg/bouncycastle/asn1/ASN1EncodableVector;)V
    ...
    iput-boolean v3, p0, Lorg/bouncycastle/asn1/DERApplicationSpecific;->isConstructed:Z
    ...
    .line 77
    :try_start_0
    invoke-virtual {p2, v2}, Lorg/bouncycastle/asn1/ASN1EncodableVector;->get(I)Lorg/bouncycastle/asn1/DEREncodable;
    ...
    new-instance v3, Lorg/bouncycastle/asn1/ASN1ParsingException;
    ...
    invoke-direct {v3, v4, v1}, Lorg/bouncycastle/asn1/ASN1ParsingException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public constructor <init>(ILorg/bouncycastle/asn1/DEREncodable;)V
    .locals 1
    .param p1, "tag"    # I
    .param p2, "object"    # Lorg/bouncycastle/asn1/DEREncodable;
...
.method public constructor <init>(ZILorg/bouncycastle/asn1/DEREncodable;)V
    ...
    .param p1, "explicit"    # Z
    .param p2, "tag"    # I
    .param p3, "object"    # Lorg/bouncycastle/asn1/DEREncodable;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method private replaceTagNumber(I[B)[B
    ...
    invoke-direct {v5, v6}, Lorg/bouncycastle/asn1/ASN1ParsingException;-><init>(Ljava/lang/String;)V
...
.method asn1Equals(Lorg/bouncycastle/asn1/DERObject;)Z
    ...
    .line 169
    instance-of v2, p1, Lorg/bouncycastle/asn1/DERApplicationSpecific;
    ...
    .line 176
    .local v0, "other":Lorg/bouncycastle/asn1/DERApplicationSpecific;
    iget-boolean v2, p0, Lorg/bouncycastle/asn1/DERApplicationSpecific;->isConstructed:Z

    iget-boolean v3, v0, Lorg/bouncycastle/asn1/DERApplicationSpecific;->isConstructed:Z

    if-ne v2, v3, :cond_0

    iget v2, p0, Lorg/bouncycastle/asn1/DERApplicationSpecific;->tag:I

    iget v3, v0, Lorg/bouncycastle/asn1/DERApplicationSpecific;->tag:I

    if-ne v2, v3, :cond_0

    iget-object v2, p0, Lorg/bouncycastle/asn1/DERApplicationSpecific;->octets:[B

    iget-object v3, v0, Lorg/bouncycastle/asn1/DERApplicationSpecific;->octets:[B
