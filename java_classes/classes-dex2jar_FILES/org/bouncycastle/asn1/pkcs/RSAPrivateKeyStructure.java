  ...
  extends ASN1Encodable
{
  ...
  public RSAPrivateKeyStructure(ASN1Sequence paramASN1Sequence)
  {
    ...
    BigInteger localBigInteger = ((DERInteger)paramASN1Sequence.nextElement()).getValue();
    if ((localBigInteger.intValue() != 0) && (localBigInteger.intValue() != 1)) {
      throw new IllegalArgumentException("wrong version for RSA private key");
    }
    this.version = localBigInteger.intValue();
    this.modulus = ((DERInteger)paramASN1Sequence.nextElement()).getValue();
    this.publicExponent = ((DERInteger)paramASN1Sequence.nextElement()).getValue();
    this.privateExponent = ((DERInteger)paramASN1Sequence.nextElement()).getValue();
    this.prime1 = ((DERInteger)paramASN1Sequence.nextElement()).getValue();
    this.prime2 = ((DERInteger)paramASN1Sequence.nextElement()).getValue();
    this.exponent1 = ((DERInteger)paramASN1Sequence.nextElement()).getValue();
    this.exponent2 = ((DERInteger)paramASN1Sequence.nextElement()).getValue();
    this.coefficient = ((DERInteger)paramASN1Sequence.nextElement()).getValue();
...
/* Location:              /home/pankaj/reverse_engineering/dex2jar-2.0/classes-dex2jar.jar!/org/bouncycastle/asn1/pkcs/RSAPrivateKeyStructure.class
