...
.method static makePBEMacParameters(Lorg/bouncycastle/jce/provider/JCEPBEKey;Ljava/security/spec/AlgorithmParameterSpec;)Lorg/bouncycastle/crypto/CipherParameters;
    .locals 7
    .param p0, "pbeKey"    # Lorg/bouncycastle/jce/provider/JCEPBEKey;
    ...
    invoke-static {v5, v6}, Lorg/bouncycastle/jce/provider/PBE$Util;->makePBEGenerator(II)Lorg/bouncycastle/crypto/PBEParametersGenerator;
    ...
    invoke-virtual {v0, v2, v5, v6}, Lorg/bouncycastle/crypto/PBEParametersGenerator;->init([B[BI)V
    ...
    invoke-virtual {v0, v5}, Lorg/bouncycastle/crypto/PBEParametersGenerator;->generateDerivedMacParameters(I)Lorg/bouncycastle/crypto/CipherParameters;
...
.method static makePBEParameters(Lorg/bouncycastle/jce/provider/JCEPBEKey;Ljava/security/spec/AlgorithmParameterSpec;Ljava/lang/String;)Lorg/bouncycastle/crypto/CipherParameters;
    ...
    invoke-virtual {v0, v3, v6, v7}, Lorg/bouncycastle/crypto/PBEParametersGenerator;->init([B[BI)V
    ...
    invoke-virtual {v0, v6, v7}, Lorg/bouncycastle/crypto/PBEParametersGenerator;->generateDerivedParameters(II)Lorg/bouncycastle/crypto/CipherParameters;
    ...
    invoke-static {v6}, Lorg/bouncycastle/crypto/params/DESParameters;->setOddParity([B)V
    ...
    invoke-virtual {v0, v6}, Lorg/bouncycastle/crypto/PBEParametersGenerator;->generateDerivedParameters(I)Lorg/bouncycastle/crypto/CipherParameters;
