...
.method public read()I
    ...
    .line 73
    iget-object v3, p0, Lorg/bouncycastle/asn1/ConstructedOctetStream;->_currentStream:Ljava/io/InputStream;

    if-nez v3, :cond_3

    .line 75
    iget-boolean v3, p0, Lorg/bouncycastle/asn1/ConstructedOctetStream;->_first:Z
    ...
    .line 80
    :cond_1
    iget-object v3, p0, Lorg/bouncycastle/asn1/ConstructedOctetStream;->_parser:Lorg/bouncycastle/asn1/ASN1StreamParser;

    invoke-virtual {v3}, Lorg/bouncycastle/asn1/ASN1StreamParser;->readObject()Lorg/bouncycastle/asn1/DEREncodable;
    ...
    .line 82
    .local v1, "s":Lorg/bouncycastle/asn1/ASN1OctetStringParser;
    if-nez v1, :cond_2
    ...
    .line 93
    .end local v1    # "s":Lorg/bouncycastle/asn1/ASN1OctetStringParser;
    :cond_3
    :goto_1
    iget-object v3, p0, Lorg/bouncycastle/asn1/ConstructedOctetStream;->_currentStream:Ljava/io/InputStream;
    ...
    .line 102
    .restart local v1    # "s":Lorg/bouncycastle/asn1/ASN1OctetStringParser;
    if-nez v1, :cond_4
...
.method public read([BII)I
    ...
    .line 22
    iget-object v5, p0, Lorg/bouncycastle/asn1/ConstructedOctetStream;->_currentStream:Ljava/io/InputStream;

    if-nez v5, :cond_2

    .line 24
    iget-boolean v5, p0, Lorg/bouncycastle/asn1/ConstructedOctetStream;->_first:Z
    ...
    .line 29
    :cond_1
    iget-object v5, p0, Lorg/bouncycastle/asn1/ConstructedOctetStream;->_parser:Lorg/bouncycastle/asn1/ASN1StreamParser;

    invoke-virtual {v5}, Lorg/bouncycastle/asn1/ASN1StreamParser;->readObject()Lorg/bouncycastle/asn1/DEREncodable;
    ...
    .line 31
    .local v2, "s":Lorg/bouncycastle/asn1/ASN1OctetStringParser;
    if-eqz v2, :cond_0

    .line 36
    const/4 v5, 0x0

    iput-boolean v5, p0, Lorg/bouncycastle/asn1/ConstructedOctetStream;->_first:Z
    ...
    .line 40
    .end local v2    # "s":Lorg/bouncycastle/asn1/ASN1OctetStringParser;
    :cond_2
    const/4 v3, 0x0
    ...
    .line 59
    .local v0, "aos":Lorg/bouncycastle/asn1/ASN1OctetStringParser;
    if-nez v0, :cond_6
