...
public class Base64Coder {
    ...
    public static String encodeLines(byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, String paramString) {
        ...
        StringBuilder localStringBuilder = new StringBuilder((paramInt2 + 2) / 3 * 4 + paramString.length() * paramInt3);
        paramInt3 = 0;
...
/* Location:              /home/pankaj/reverse_engineering/dex2jar-2.0/classes-dex2jar.jar!/biz/source_code/base64Coder/Base64Coder.class
