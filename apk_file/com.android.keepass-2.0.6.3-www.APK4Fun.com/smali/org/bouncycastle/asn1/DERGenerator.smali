...
.method writeDEREncoded(I[B)V
    ...
    .prologue
    .line 79
    iget-boolean v3, p0, Lorg/bouncycastle/asn1/DERGenerator;->_tagged:Z

    if-eqz v3, :cond_2

    .line 81
    iget v3, p0, Lorg/bouncycastle/asn1/DERGenerator;->_tagNo:I

    or-int/lit16 v2, v3, 0x80

    .line 83
    .local v2, "tagNum":I
    iget-boolean v3, p0, Lorg/bouncycastle/asn1/DERGenerator;->_isExplicit:Z
    ...
    invoke-virtual {p0, v3, v4, p2}, Lorg/bouncycastle/asn1/DERGenerator;->writeDEREncoded(Ljava/io/OutputStream;I[B)V
    ...
    invoke-virtual {p0, v3, v2, p2}, Lorg/bouncycastle/asn1/DERGenerator;->writeDEREncoded(Ljava/io/OutputStream;I[B)V
    ...
    invoke-virtual {p0, v3, p1, p2}, Lorg/bouncycastle/asn1/DERGenerator;->writeDEREncoded(Ljava/io/OutputStream;I[B)V
