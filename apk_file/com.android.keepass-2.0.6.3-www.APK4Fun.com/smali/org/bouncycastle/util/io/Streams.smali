...
.method public static drain(Ljava/io/InputStream;)V
    ...
    .prologue
    .line 15
    sget v1, Lorg/bouncycastle/util/io/Streams;->BUFFER_SIZE:I
...
.method public static pipeAllLimited(Ljava/io/InputStream;JLjava/io/OutputStream;)J
    ...
    .line 74
    .local v2, "total":J
    sget v4, Lorg/bouncycastle/util/io/Streams;->BUFFER_SIZE:I
    ...
    .line 81
    new-instance v4, Lorg/bouncycastle/util/io/StreamOverflowException;

    const-string v5, "Data Overflow"

    invoke-direct {v4, v5}, Lorg/bouncycastle/util/io/StreamOverflowException;-><init>(Ljava/lang/String;)V
